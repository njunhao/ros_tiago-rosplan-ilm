...
/**
 * This file defines the RPMove class.
 * RPMove is used to connect ROSPlan to the MoveBase library.
...
namespace KCL_rosplan {
	...
	class RPMove: public RPProbActionInterface
	{
	...
	public:
		...
		/* constructor */
		RPMove(ros::NodeHandle &nh, std::string &actionserver);
